module SpreeSlider
  class InstallSimpleCarouselGenerator < Rails::Generators::Base
    ...
    def install
      ...
      #add javascripts
      append_file "vendor/assets/javascripts/spree/store/all.js", "//= require simple.carousel\n"
      append_file "vendor/assets/javascripts/spree/store/all.js", "//= require simple.carousel.slider\n"
